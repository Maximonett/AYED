...
public class ParcialArboles {
	...
	private static boolean resolverHelper(GeneralTree<Integer> tree) {
		int cantActual=1; //nodos en la raiz
		int nodosAnt=0; // nodos anterior es cero porque estamos en la raiz
		GeneralTree<Integer> ab;
		Queue<GeneralTree<Integer>> cola =new Queue<>();
		cola.enqueue(tree); // === ENCOLAR la raíz ===
		while(!cola.isEmpty()) {
