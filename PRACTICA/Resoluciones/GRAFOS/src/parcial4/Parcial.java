...
public class Parcial {
	...
	// COMO MARCAR VERTICES QUE NO QUIERO RECORRER!!!!!
	...
	private Vertices buscar(Graph<String> sitios,String origen,String destino) {
		...
		for (Vertex<String> aux : sitios.getVertices()) {
	...
	private void dfs(Graph<String>sitios,List<Camino> lis,List<String>lisActual
			,Vertex<String>origen,Vertex<String> destino,int cuadras,boolean[]marcas) {
