...
public class TestBalanceo {
    ...
    //(1) Si el String no es par ya se que la pila nunca va a quedar vacia. 
    //Si el primer caracter del String es de cierre ya se que va a dar error, 
    //porque se va a intentar un POP. Descarto esos casos y devuelvo fallse directamente.
    //(2) Tomo el caracter actual, verifico si es de apertura o cierre.  
    //En caso de que sea cierre en elem me guardo el elemento popeado, y 
    //verifico si la posicion donde esta ubicado el caracter de apertura 
    //coincide con la posicion del caracter de cierre. 
    //En caso que no coincida la posicion significa que son distintos, 
    //esto es asi por como los guarde en las listas. En caso de que sean iguales sigo procesando.
    //(3) El unico caso donde el String esta balanceado es cuando al 
    //finalizar el modulo la pila quedo vacia, en caso contrario no esta balanceado el String.
