...
public class AplicacionDePrueba {
	...
	public static void main(String[] args) {
         ...
         arrAlumnos[2].setLegajo(new String("12345/0"));
         arrAlumnos[2].setDni(29654879);
         arrAlumnos[2].setApellido(new String("Rodriguez"));
         arrAlumnos[2].setNombre(new String("Bender"));
         arrAlumnos[2].setEmail(new String("benderRodri@homail.com"));
